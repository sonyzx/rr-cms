     ...
     /**
       ...
       public function send_email_smtp($email_to, $subject, $attachment,$body_email){               
              ...
              // Set your email information
               $from = array('email' => 'wahyuuu@gmail.com', 'name' => 'Basic CMS V.1'); 
               // Set your email information
               ...
               if (!$CI->email->send()) {                 
                   ...
                   $result['error_code'] = 2;
                   $result['error_msg'] = show_error($CI->email->print_debugger());                   
               }
               else {
                   $CI->session->set_flashdata('flashSuccess', $CI->lang->line('successsend')); 
                   $result['error_code'] = 4;
                   $result['error_msg'] = $CI->lang->line('successsend');   
               }               
       }
