                                            ...
                                            <div class="col-sm-9">
                                                <div id="userSettingsContent" class="tab-content">
                                                    ...
                                                    <div class="tab-pane fade in" id="changePassword">
                                                        ...
                                                        <form name="changepassword" method="post" id="changepassword" role="form" action="<?php echo site_url('cms/users/changepassword');?>">
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label><?php echo "Level Access";?></label>
                                                                <select name="level" id="level" class="form-control">
                                                                    <option value="admin" <?php echo ($levelaccess=="admin")? 'selected="selected"' : '';?> >Administrator</option>
                                                                    <option value="users" <?php echo ($levelaccess=="users")? 'selected="selected"' : '';?> >Users</option>
                                                                </select>
                                                            </div>
